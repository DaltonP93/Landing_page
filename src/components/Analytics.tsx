...
/**
 * Inyecta los scripts de marketing configurados desde el panel:
 * Google Analytics 4, Google Tag Manager y Facebook Pixel.
 * Si un ID está vacío, ese script no se carga.
 */
